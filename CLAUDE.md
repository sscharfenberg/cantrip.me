...
- `DeckCollectionStatusService` — read-side: resolves `effectiveMode`, ships `statusForDeck` (mode C), `implicitStatusForDeck` (mode B) or `availabilityForDeck` (planned decks, any mode) to the controller.
